var ConfigCH = function()
{
    this.bgColor = 0x8fa5de;
    this.imgPath = 'img/ch/';
    ...
    this.pathMob = [
        [ 60,216,"obj_1",0.8,0.5],
        [ 31,333,"obj_2",0.8,0.5],
        [133,429,"obj_3",0.8,0.5],
        [ 66,524,"obj_4",0.8,0.5],
        [156,596,"obj_5",0.8,1],
        [ 40,725,"obj_6",0.8,1],
        [242,713,"obj_7",0.8,1],
        [327,633,"obj_8",0.8,1],
        [279,488,"obj_9",0.8,1],
        [337,330,"obj_10",0.8,1],
        [299,183,"obj_11",0.8,1],
        [130,275,"obj_12",0.8,1]];

    this.scene = [
        [2455,321,"./img/ch/bg_dsc.png",1,1],
        [-820,321,"./img/ch/bg_dsc.png",1,1],
        [820,321,"./img/ch/bg_dsc.png",1,1],
        [730,276,"pine",1,1,20],
        ...
        [900,250,"./img/ch/ginger-bread-house.png",1,1],
        [1010,261,"pine",1,1],
    ...
    this.sceneMob = [
        [187,398,"./img/ch/bg_mob_ex.png",1.01,1],
        [77,296,"pine",0.6,1,-20],
        [277,296,"pine",0.6,1],

        [205,280,"./img/ch/ginger-bread-house.png",0.8,1]
    ];
    ...
    this.buttons = [
        {
            ...
            text:[760, 595, "", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
    ...
    this.texts = [
        ...
        [570, 21, "12 DAYS OF CRISTMAS", {"fill":"0xfffe8d", "align":"center", fontSize: 54, fontFamily: "AG_Book"}],

        [412,203, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [422,223, "1", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        [528,155, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [538,175, "2", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        [610,214, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [620,234, "3", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        ...
        [1230,252, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [1220,272, "10", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        [1052,187, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [1042,207, "11", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        [800, 201, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [790, 221, "12", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}]
    ];

    this.textsMob = [
        [92, 23, "12 DAYS OF\nCRISTMAS", {"fill":"0x60868c", "align":"center", fontSize: 36, fontFamily: "AG_Book"}],
        [90, 21, "12 DAYS OF\nCRISTMAS", {"fill":"0xfffe8d", "align":"center", fontSize: 36, fontFamily: "AG_Book"}],
        ...
        [ 80,166, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [ 85,186, "1", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        ...
        [280,206, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [273,228, "11", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}],
        ...
        [110,256, "Day", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
        [103,278, "12", {"fill":"0xfffe8d", "align":"center", fontSize: 48, fontFamily: "AG_Book"}]
    ];
    ...
    this.popup = [
        {type:"image", data:[187,398,"./img/ch/bg_popup.png",1.01,1]},
        ...
        {type:"button", data:{
            image:[180,710,"./img/ch/button.png",1.25,1],
            text:[135, 695, "COLLECT", {"fill":"0xfffe8d", "align":"center", fontSize: 24, fontFamily: "AG_Book"}],
